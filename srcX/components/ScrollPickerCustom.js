...
export default class ScrollPickerCustom extends React.Component {
    constructor() {
        super();
    ...
    renderCustomItem = () => {
        if (this.props.renderItem) {
            return this.props.dataSource.map((item, index) => {
                ...
                return this.props.renderItem(item, index, isSelected);
            });
        }
        return this.props.dataSource.map(this.renderItem.bind(this));
    }
...
ScrollPickerCustom.defaultProps = {
    dataSource: [1, 2, 3],
    itemHeight: 60,
